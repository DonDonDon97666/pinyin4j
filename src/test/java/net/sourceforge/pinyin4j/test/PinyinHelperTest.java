...
public class PinyinHelperTest extends TestCase {
    ...
    public void testUsernameToHanYuPinYin() throws BadHanyuPinyinOutputFormatCombination {


        String[] names = {"吴延昭", "林斐", "多国蒙", "王安珍", "王明阳", "秦艺涓", "易文"};

        HanyuPinyinOutputFormat outputFormat = new HanyuPinyinOutputFormat();
        outputFormat.setToneType(HanyuPinyinToneType.WITHOUT_TONE);

        String[] multi = PinyinHelper.toHanyuPinyinStringArray('长', outputFormat);
        ...
        for (String name : names) {
            ...
            for (char aChar : chars) {
                String pinyin = PinyinHelper.toHanyuPinyinStringArray(aChar, outputFormat)[0];
    ...
    public void testMultiHanziToHanYuPinYin() throws BadHanyuPinyinOutputFormatCombination {
        MultiPinyinConfig.multiPinyinPath = "/pinyindb/multi_pinyin_extend.txt";

        String[] names = {"吴延昭", "长上", "长亲", "长假", "王明阳", "秦艺涓", "易文", "长发", "长吁短叹", "长吏"};
        ...
        for (String name : names) {
            System.out.println("-------------- " + name);
            String s = PinyinHelper.toHanYuPinyinString(name, outputFormat, ",", true);
